...
const accountUrl = "https://bhxh.vinbigdata.co.uk/api/read-gg-sheet/Account";
const loginUrl = "https://bhxh.vinbigdata.co.uk/api/read-gg-sheet/login";
const historyUrl = "https://bhxh.vinbigdata.co.uk/api/read-gg-sheet/History";
const urlInformation =
  "https://raw.githubusercontent.com/kenzouno1/DiaGioiHanhChinhVN/master/data.json";
const urlApiVn = "https://provinces.open-api.vn/api/";
