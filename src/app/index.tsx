  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
          ...
          Tôi đồng ý với <Text style={[styles.highlightText]}>Chính sách quyền riêng tư</Text> và <Text style={styles.highlightText}>Điều khoản sử dụng ứng dụng và dịch vụ</Text>
        </Text>
          </View>
        </View>
        ...
        <View style={styles.buttonContainerFooter}>
          <TouchableOpacity
            ...
            disabled={!isChecked}
          >
            <Text style={{ textAlign: "center", fontFamily:'sans-serif', fontWeight:'bold', color: isChecked ? '#fff' : '#C5C5C5' }}>Bắt đầu sử dụng</Text>
          </TouchableOpacity>
        </View>
          </>
        }
