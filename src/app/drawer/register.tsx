...
const RegisterScreen = () => {
  ...
  if (!loading) <ActivityIndicator size="large" color="#FFF" />
  return (
            ...
            <View style={[globalStyles.contentLogin, { marginTop: 20 }]}>
              ...
              <View>
                <ResponsiveTextInput
                  ...
                  onBlur={handleBlur}
                />
                <Text style={[globalStyles.textLogin, { marginBottom: 20 }]}>
                  {`${isRegister ? "Mật khẩu" : "Số điện thoại"}`}{" "}
                </Text>
                <ResponsiveTextInput
                  placeholder={
                    isRegister ? "Nhập mật khẩu" : "Nhập số điện thoại"
                  }
