    ...
    const renderColumn = ({
        ...
        <View style={[styles.column]}>
            ...
            <View style={styles.container}>
                <Text
                    numberOfLines={2}
                    ellipsizeMode='tail' // Sử dụng 'tail' để hiển thị ... ở cuối
            ...
            <View style={[styles.editContainer, {flex: 1, backgroundColor: 'white', paddingTop: 10}]}>
                <AppImage source={icon2} style={styles.icImage}/>
            </View>
            <View style={{flexDirection: 'row', alignItems: 'center', paddingVertical: 10}}>
                <Feather name="calendar" size={24} color="#9c9c9c"/>
                <Text style={{color: '#9c9c9c', paddingHorizontal: 5}}>12-09-2024</Text>
            </View>
                ...
                >
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.rowContainer}>
                            ...
                            <View style={{width: 2, height: '100%', backgroundColor: '#dddddd', marginHorizontal: 5}}/>
                            {renderColumn({
                                titleInfor: "Tin tức",
...
const styles = StyleSheet.create({
    ...
    textItem: {
        fontFamily: 'YourFontFamily', // Thay thế bằng font family của bạn
        fontWeight: '700',
        fontSize: 16,
    },
});
